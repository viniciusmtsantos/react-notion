...
function App() {
  return (
    <div className='min-h-screen p-8 text-zinc-50 bg-gradient-to-r from-pink-300 via-pink-300 to-indigo-400'>
      <div className="bg-zinc-800 w-[1100px] mx-auto rounded-xl min-h-[700px] shadow-sm border border-black/20 overflow-hidden grid grid-cols-[16rem_1fr]">
